...
fieldSpecResampled <- function(directory, outputName = "spectralLibrary") {
  tryCatch({
    ...
    write.csv(spectralLibrary_010nm, paste(paste("output/outputSpectralLibraries/", outputName, sep = ""), "_010nm_equal25.csv", sep = ""), row.names = FALSE)
    write.csv(spectralLibrary_050nm, paste(paste("output/outputSpectralLibraries/", outputName, sep = ""), "_050nm_equal25.csv", sep = ""), row.names = FALSE)
    write.csv(spectralLibrary_100nm, paste(paste("output/outputSpectralLibraries/", outputName, sep = ""), "_100nm_equal25.csv", sep = ""), row.names = FALSE)
